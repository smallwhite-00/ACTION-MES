...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="">电子秤${not empty androidPAD.id?'修改':'添加' }</a></li>
	</ul>
	<br/>
	<!-- 2.表单部分 -->
	<form:form id="inputForm" method="post" action="${ctx}/bas/electronSteelYard/save" modelAttribute="electronSteelYard" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect url="/sys/office/treeData" id="office" value="${electronSteelYard.organization.id}" labelName="organization.name" 
				labelValue="${electronSteelYard.organization.name}" title="机构" name="office.id" cssClass="input-larg" allowClear="true"/>
			</div>
		</div>
