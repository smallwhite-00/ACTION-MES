...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="">Bom${not empty bom.id?'修改':'添加' }</a></li>
	</ul>
	<br/>
	<!-- 2.表单 -->
	<form:form id="inputForm" method="post" action="${ctx}/bas/bom/save" modelAttribute="bom" class="form-horizontal">
		<form:hidden path="id"/>
