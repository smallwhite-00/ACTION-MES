...
<body>
	...
	<br/>
	<!-- 2.表单 -->
	<form:form id="inputForm" method="post" action="${ctx}/bas/product/save" modelAttribute="product" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="productDesc" htmlEscape="false" maxlength="200"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">属性：</label>
			<div class="controls">
				<form:textarea path="productProp" htmlEscape="false" maxlength="200"/>
			</div>
		</div>
		<div class="control-group">
