...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="">条码打印机${not empty codePrinter.id?'修改':'添加' }</a></li>
	</ul>
	<br/>
	<!-- 2.表单部分 -->
	<form:form id="inputForm" method="post" action="${ctx}/bas/codePrinter/save" modelAttribute="codePrinter" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="cPNumber" htmlEscape="false" maxlength="50" class="required"/>
				<span class="help-inline"><font color="red">*</font></span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect url="/sys/office/treeData" id="office" value="${codePrinter.organization.id}" labelName="organization.name" 
				labelValue="${codePrinter.organization.name}" title="机构" name="office.id" cssClass="input-larg" allowClear="true"/>
			</div>
		</div>
